...
| Optional | GDELT | Geopolitical risk confounder — currently a 5-day proof-of-concept sample only; see `11_limitations.md` |
...
| Phase | Notebook | Status (as of 2026-07-04) |
|-------|----------|------|
...
| 5 — Feature Engineering | `05_feature_engineering.ipynb` | ✅ Complete |
| 6 — Model Training | `06_model_training.ipynb` | ✅ Complete |
| 7 — Model Evaluation | `07_model_evaluation.ipynb` | ✅ Complete |
| 8 — Results Visualisation | `08_results_visualisation.ipynb` | ✅ Complete |
