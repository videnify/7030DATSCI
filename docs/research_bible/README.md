...
| [`feature_contract.md`](feature_contract.md) | Consumption rules for `feature_matrix.parquet` (FES v1.0, Mission 05B) — baseline eligibility, scaling/encoding rules, versioning |
...
| [`baseline_model_specification.md`](baseline_model_specification.md) | Exact, reproducible specification of `Baseline_LASSO` v1.0 |
| [`baseline_evaluation.md`](baseline_evaluation.md) | Full evaluation, comparison-baseline context, and interpretation of `Baseline_LASSO` v1.0 |
