...
| Freeze Date | 2026-07-06; controlled Dataset v1.2/FES v1.1 amendment 2026-07-14 |
...
**2026-07-15 current boundary:** Dataset v1.2, FES v1.1, MCP v1.0 and visualisation v1.2 are current. The pre-specified RQ1 reporting gate is complete as RQ1-v1.0: five mean-CAR tests with 95% intervals, Cohen's d and BH-FDR, validated `PASS`. Remaining work is dissertation citation/cross-reference and submission QA, not new analysis or model regeneration.
...
Project Governance Freeze              (2026-07-06 — this document)
        ↓
RQ1 reporting freeze                  (2026-07-15 — BH-FDR/95% CI/Cohen's d complete; validation PASS)
```
...
| **Feature Engineering** | FES v1.1 — `feature_contract.md`, `06_feature_dictionary.md` |
