...
| 3 | `03_event_detection.ipynb` (as `03_event_detection_revised.ipynb`) | ✅ Complete — **rebuilt 2026-07-13**: economic pre-filter now scopes the APP catalogue to 916 documents (344 high-impact events); GDELT merged as a continuous confounder, not a catalogue event | 4 processed parquets, incl. `gdelt_daily_risk.parquet`, 4 figures |
